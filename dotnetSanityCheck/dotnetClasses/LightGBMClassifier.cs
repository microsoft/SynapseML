...
namespace Synapse.ML.Lightgbm
{
    ...
    public class LightGBMClassifier : JavaEstimator<LightGBMClassificationModel>, IJavaMLWritable, IJavaMLReadable<LightGBMClassifier>
    {
        ...
        /// <summary>
        /// Sets isUnbalance value for <see cref="isUnbalance"/>
        /// </summary>
        /// <param name="isUnbalance">
        ...
        /// </returns>
        public object GetFobj() => (object)Reference.Invoke("getFobj");
        ...
        /// <summary>
        /// Gets isUnbalance value for <see cref="isUnbalance"/>
        /// </summary>
        /// <returns>
