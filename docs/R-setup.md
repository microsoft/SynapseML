...
```R
...
devtools::install_url("https://mmlspark.azureedge.net/rrr/mmlspark-1.0.0-rc2.zip")
...
```
...
library(dplyr)
config <- spark_config()
config$sparklyr.defaultPackages <- "com.microsoft.ml.spark:mmlspark_2.11:1.0.0-rc2"
