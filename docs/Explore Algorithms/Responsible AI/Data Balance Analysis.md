...
| Chi-Squared Test         | The chi-square test tests the null hypothesis that the categorical data has the given frequencies given expected frequencies in each category.                                                                                                                                                                                                            | Smaller right-tail p-values give stronger evidence against the null hypothesis; an infinite statistic has p-value 0.     | [Link](https://en.wikipedia.org/wiki/Chi-squared_test)                                 |
