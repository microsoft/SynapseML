...
import com.microsoft.azure.synapse.ml.stages.{DynamicMiniBatchTransformer, FixedMiniBatchTransformer, PartitionConsolidator, TimeIntervalMiniBatchTransformer}
