...
curl https://archive.apache.org/dist/spark/spark-3.5.0/spark-3.5.0-bin-hadoop3.tgz -o spark-3.5.0-bin-hadoop3.tgz
mkdir ~/bin
tar -xzvf spark-3.5.0-bin-hadoop3.tgz -C ~/bin
export SPARK_HOME=~/bin/spark-3.5.0-bin-hadoop3/
