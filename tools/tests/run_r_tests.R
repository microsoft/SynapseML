...
tryCatch({
  ...
  flush.console()
  Sys.sleep(1)
  spark_install_find(version = "3.2.0", hadoop_version = "2.7")
  flush.console()
  Sys.sleep(1)
...
error=function(err) {
  print("Installing ../../../../../../../spark-3.2.0-bin-hadoop2.7.tgz")
  flush.console()
  Sys.sleep(1)
  spark_install_tar("../../../../../../../spark-3.2.0-bin-hadoop2.7.tgz")
  flush.console()
  Sys.sleep(1)
  print("installed ../../../../../../../spark-3.2.0-bin-hadoop2.7.tgz")
  flush.console()
  Sys.sleep(1)
})
