...
# If SPARK_HOME is already set (by the CI pipeline), use that installation directly.
# Otherwise install the tarball via sparklyr and let it manage the location.
