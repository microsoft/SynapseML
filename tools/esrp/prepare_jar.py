...
from verify_release import PUBLIC_MAVEN_MODULES, maven_artifact_filename  # noqa: E402
    ...
    for name in PUBLIC_MAVEN_MODULES:
        ...
        for path in sorted(source.rglob("*")):
            ...
            if not suffix.startswith((".", "-")):
                continue
            filename = maven_artifact_filename(
        ...
        for filename, path in selected.items():
            if filename.endswith(".jar") and not zipfile.is_zipfile(path):
