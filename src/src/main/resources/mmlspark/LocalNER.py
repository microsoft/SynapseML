...
@inherit_doc
class LocalNER(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    """
    ...
    def __init__(self, concurrency=1, concurrentTimeout=100.0, errorCol=None, handler=None, language=None, outputCol=None, subscriptionKey=None, text=None, timeout=60.0, url=None):
        super(LocalNER, self).__init__()
        self._java_obj = self._new_java_obj("com.microsoft.ml.spark.LocalNER")
        self._cache = {}
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.ml.spark.LocalNER"

    @staticmethod
    def _from_java(java_stage):
        module_name=LocalNER.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".LocalNER"
