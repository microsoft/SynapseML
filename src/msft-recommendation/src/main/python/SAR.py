...
class MsftRecommendationModel(model):
    ...
    Args:
        ...
        supportThreshold (str): Warm Cold Item Threshold (default: 4)
        time (str): Time of activity (default: time)
    ...
    def __init__(self, alpha=1.0, checkpointInterval=10, coldStartStrategy="nan", finalStorageLevel="MEMORY_AND_DISK",
                 ...
                 ratingCol="rating", regParam=0.1, seed=1766449073, supportThreshold="4", time="time", userCol="user"):
        ...
        self.supportThreshold = Param(self, "supportThreshold",
                                      "supportThreshold: Warm Cold Item Threshold (default: 4)")
        self._setDefault(supportThreshold="4")
        self.time = Param(self, "time", "time: Time of activity (default: time)")
        self._setDefault(time="time")
    ...
    def getSupportThreshold(self):
        ...
        Returns:
            ...
            str: Warm Cold Item Threshold (default: 4)
        """
    ...
    def _create_model(self, java_model):
        return SARModel(java_model)


class SARModel(ComplexParamsMixin, JavaModel, JavaMLWritable, JavaMLReadable):
    """
    Model fitted by :class:`SAR`.
    ...
    @staticmethod
    def _from_java(java_stage):
        module_name = SARModel.__module__
