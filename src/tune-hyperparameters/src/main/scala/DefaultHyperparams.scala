...
object DefaultHyperparams {
  ...
  def defaultRange(learner: LogisticRegression): Array[(Param[_], Dist[_])] = {
    new HyperparamBuilder().addHyperparam(learner.regParam, new DoubleRangeHyperParam(0.001, 1.0))
  ...
  def defaultRange(learner: DecisionTreeClassifier): Array[(Param[_], Dist[_])] = {
    new HyperparamBuilder().addHyperparam(learner.maxBins, new IntRangeHyperParam(16, 32))
  ...
  /**
    ...
    */
  def defaultRange(
      learner: MultilayerPerceptronClassifier): Array[(Param[_], Dist[_])] = {
    val layers = Array[Int](2, 5, 2)
    new HyperparamBuilder().addHyperparam(learner.blockSize, new IntRangeHyperParam(10, 200))
