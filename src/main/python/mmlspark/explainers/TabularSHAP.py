...
class TabularSHAP(LocalExplainer):
    ...
    def __init__(
        ...
        model=None,
        numSamples=None,
        outputCol="TabularSHAP_7ab60e8341d3__output",
        targetClass=0,
        targetClassCol=None,
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.ml.spark.explainers.TabularSHAP", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(metricsCol="r2")
        self._setDefault(outputCol="TabularSHAP_7ab60e8341d3__output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.ml.spark.explainers.TabularSHAP"
