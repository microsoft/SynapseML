...
class TextSHAP(_LocalExplainer):
    ...
    def __init__(
        ...
        model=None,
        numSamples=None,
        outputCol="TextSHAP_d1c015326d6a__output",
        targetClass=0,
        targetClassCol=None,
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.ml.spark.explainers.TextSHAP", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(metricsCol="r2")
        self._setDefault(outputCol="TextSHAP_d1c015326d6a__output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.ml.spark.explainers.TextSHAP"
