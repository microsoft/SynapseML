...
class VectorLIME(LocalExplainer):
    ...
    def __init__(
        ...
        model=None,
        numSamples=1000,
        outputCol="VectorLIME_9bb1d55c2da3__output",
        regularization=0.0,
        targetClass=0,
        targetClassCol=None,
        ...
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.ml.spark.explainers.VectorLIME", self.uid)
        else:
            self._java_obj = java_obj
        self._setDefault(kernelWidth=0.75)
        self._setDefault(metricsCol="r2")
        self._setDefault(numSamples=1000)
        self._setDefault(outputCol="VectorLIME_9bb1d55c2da3__output")
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.ml.spark.explainers.VectorLIME"
