...
from mmlspark.vw._VowpalWabbitRegressor import _VowpalWabbitContextualBandit, _VowpalWabbitContextualBanditModelModel
from pyspark.ml.common import inherit_doc

@inherit_doc
class VowpalWabbitContextualBandit(_VowpalWabbitContextualBandit):
    def _create_model(self, java_model):
        model = VowpalWabbitContextualBanditModelModel()
...
@inherit_doc
class VowpalWabbitContextualBanditModelModel(_VowpalWabbitContextualBanditModelModel):
