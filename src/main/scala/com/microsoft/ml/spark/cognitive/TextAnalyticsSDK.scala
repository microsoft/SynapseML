...
class Healthcare (override val textAnalyticsOptions: Option[TextAnalyticsRequestOptionsV4] = None,
  ...
  TAResponseV4[AnalyzeHealthcareEntitiesResultV4] = {
    ...
    val resultCollection = try {
     val poller = textAnalyticsClient.beginAnalyzeHealthcareEntities(documents, null, Context.NONE);
    ...
    val analyzeHealthcareEntitiesResultCollection = resultCollection.asScala

    def getDataSources(ent: EntityDataSource): EntityDataSourceV4 = {
      EntityDataSourceV4(
        ent.getName,
        ent.getEntityId
      )
    ...
    def getHealthcareEntity(ent: HealthcareEntity): HealthcareEntityV4 = {
      HealthcareEntityV4(
        ent.getAssertion,
        ent.getCategory,
