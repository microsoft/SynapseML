...
**Reviewed source tree:** `6d1a9a443e2693c8b98dcee14e867678545f3dd4`.
...
- Red controls reproduced the original parser bug and both successive
  diagnostics gaps. Final `spark41-cleanup-round4-green.log` records zero
...
- Aggregate compile/test compile/styles/codegen, 30 codegen and 36 cognitive
  ...
  wheels supplied 54 Python tests plus 160 subtests on Spark 4.1.1/Python
  3.13.13. JUnit reports 214 executions, zero failures/errors/skips; wrapper and
