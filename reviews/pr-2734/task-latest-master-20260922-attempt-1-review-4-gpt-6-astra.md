...
| Prior locally validated tree | `7ba0eb1de595bc97ceddccf300362ec574822d42` |
...
| Artifact | `reviews\pr-2734\task-latest-master-20260922-attempt-1-review-4-gpt-6-astra.md` |
...
adds no broad discovery or test rerun. Previous local-validation evidence,
including the preserved WSL Git-fixture rerun caveat, is not presented as a new
run against the updated documentation.
