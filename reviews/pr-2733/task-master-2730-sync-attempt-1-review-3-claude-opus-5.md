# Round 3 — Edge cases and robustness — master #2730 sync (Spark 4.0 port, PR 2733)
...
| Baseline head | `d08aefee223d5fd7024a78dcd5e19a60b323967d` |
| MERGE_HEAD | `681bd96990c421de3b91d2b1bf8f8f470764199d` |
| Source tree | `ce3d1c2567a6d8def64fb7d926b4b41556302fc8` — matches the value supplied for this round |
...
every blob against the Spark 4.1 port's index: **all nine identical**. No product,
...
- Prior CI 237087792 passed for this port, and the other port's 237100199 was
  pending at its old head. Neither validates this unpublished merge.
