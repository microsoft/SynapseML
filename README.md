...
[![Version](https://img.shields.io/badge/version-0.9.2-blue)](https://github.com/Microsoft/SynapseML/releases) [![Snapshot Version](https://mmlspark.blob.core.windows.net/icons/badges/master_version3.svg)](#sbt) 
...
Scala](https://mmlspark.blob.core.windows.net/docs/0.9.2/scala/index.html#package) and [for
PySpark](https://mmlspark.blob.core.windows.net/docs/0.9.2/pyspark/index.html).
...
```bash
spark-shell --packages com.microsoft.azure:synapseml:0.9.2
...
For the coordinates use: `com.microsoft.azure:synapseml:0.9.2` 
...
`https://mmlspark.blob.core.windows.net/dbcs/SynapseMLExamplesv0.9.2.dbc`
