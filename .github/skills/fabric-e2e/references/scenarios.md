...
The lifecycle profile intentionally uses one feature. Current multi-feature
reference-dataset creation can fail earlier with duplicate generated names,
which would mask the streaming ownership and repeated-fit path this scenario
...
One small structured prompt covers behaviors inspired by PySpark AI
