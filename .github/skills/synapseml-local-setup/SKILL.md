...
description: Set up and validate the Spark 4.1 SynapseML branch locally in WSL or Linux. Use for sbt compile/test, Java toolchain, Scala 2.13, Spark, or local validation failures.
compatibility: Linux/WSL with bash, git, rg, sbt, and JDK 17 installed. Designed for the SynapseML spark4.1 branch.
---
...
- SynapseML: Scala `2.13.17`, Spark `4.1.1`
