...
class Document:
    def __init__(self, input_path, output_dir, owner, repo, service, new_title):
...
if __name__ == "__main__":
    ...
    doc = Document(args.input_path, args.output_dir, args.owner, args.repo, args.service, args.new_title)
    doc.run()