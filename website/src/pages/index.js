                    ...
                    snippet={`%%configure -f
{
  "name": "synapseml",
  "conf": {
      "spark.jars.packages": "com.microsoft.azure:synapseml_2.12:1.0.14",
  ...
  "conf": {
      ...
      "spark.sql.parquet.enableVectorizedReader": "false"
                ...
                <TabItem value="Spark Packages">
                  ...
                  <CodeSnippet
                    snippet={`spark-shell --packages com.microsoft.azure:synapseml_2.12:1.0.14 # Please use 1.0.14 version for Spark3.4 and 0.11.4-spark3.3 version for Spark3.3
pyspark --packages com.microsoft.azure:synapseml_2.12:1.0.14
spark-submit --packages com.microsoft.azure:synapseml_2.12:1.0.14 MyApp.jar `}
                    lang="bash"
                  ></CodeSnippet>
                ...
                <TabItem value="Databricks">
                  ...
                  <p>
                    ...
                    Spark 3.4 Cluster:
                    <CodeSnippet
                      snippet={`com.microsoft.azure:synapseml_2.12:1.0.14`}
                      lang="bash"
                    ></CodeSnippet>
                    Spark 3.3 Cluster:
                    <CodeSnippet
                  ...
                  <CodeSnippet
                    snippet={`https://mmlspark.blob.core.windows.net/dbcs/SynapseMLExamplesv1.0.14.dbc`}
                    lang="bash"
                  ></CodeSnippet>
                </TabItem>
...
spark = (pyspark.sql.SparkSession.builder.appName("MyApp")
        .config("spark.jars.packages", "com.microsoft.azure:synapseml_2.12:1.0.14") # Please use 1.0.14 version for Spark3.4 and 0.11.4-spark3.3 version for Spark3.3
...
libraryDependencies += "com.microsoft.azure" %% "synapseml_2.12" % "1.0.14" // Please use 1.0.14 version for Spark3.2 and 1.0.14-spark3.3 version for Spark3.3`}
                    lang="jsx"
                  ></CodeSnippet>
                </TabItem>
              </Tabs>
