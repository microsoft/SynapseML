  ...
  "conf": {
      ...
      "spark.sql.parquet.enableVectorizedReader": "false"
                ...
                <TabItem value="Spark Packages">
                  ...
                  <CodeSnippet
                    snippet={`spark-shell --packages com.microsoft.azure:synapseml_2.12:1.1.1 # Please use 1.1.1 version for Spark3.5 and 1.1.1 version for Spark3.4
...
spark-submit --packages com.microsoft.azure:synapseml_2.12:1.1.1 MyApp.jar `}
                ...
                <TabItem value="Databricks">
                  ...
                  <p>
                    ...
                    Spark 3.5 Cluster:
                    <CodeSnippet
                      snippet={`com.microsoft.azure:synapseml_2.12:1.1.1`}
                      lang="bash"
                    ></CodeSnippet>
                    Spark 3.4 Cluster:
                    <CodeSnippet
                  ...
                  <CodeSnippet
                    snippet={`https://mmlspark.blob.core.windows.net/dbcs/SynapseMLExamplesv1.1.1.dbc`}
                    lang="bash"
                  ></CodeSnippet>
                </TabItem>
...
spark = (pyspark.sql.SparkSession.builder.appName("MyApp")
        .config("spark.jars.packages", "com.microsoft.azure:synapseml_2.12:1.1.1") # Please use 1.1.1 version for Spark3.5 and 1.1.1 version for Spark3.4
...
libraryDependencies += "com.microsoft.azure" %% "synapseml_2.12" % "1.1.1" // Please use 1.1.1 version for Spark3.5 and 1.0.15 version for Spark3.4`}
                    lang="jsx"
                  ></CodeSnippet>
                </TabItem>
              </Tabs>
