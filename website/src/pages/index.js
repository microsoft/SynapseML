                    ...
                    snippet={`%%configure -f
{
  "name": "synapseml",
  "conf": {
      "spark.jars.packages": "com.microsoft.azure:synapseml_2.12:1.0.0-spark3.3",
                    ...
                    snippet={`%%configure -f
{
  "name": "synapseml",
  "conf": {
      "spark.jars.packages": "com.microsoft.azure:synapseml_2.12:1.0.0,org.apache.spark:spark-avro_2.12:3.3.1",
      "spark.jars.repositories": "https://mmlspark.azureedge.net/maven",
      "spark.jars.excludes": "org.scala-lang:scala-reflect,org.apache.spark:spark-tags_2.12,org.scalactic:scalactic_2.12,org.scalatest:scalatest_2.12,com.fasterxml.jackson.core:jackson-databind",
      "spark.yarn.user.classpath.first": "true",
      "spark.sql.parquet.enableVectorizedReader": "false",
  ...
  "conf": {
      ...
      "spark.sql.legacy.replaceDatabricksSparkAvro.enabled": "true"
                ...
                <TabItem value="Spark Packages">
                  ...
                  <CodeSnippet
                    snippet={`spark-shell --packages com.microsoft.azure:synapseml_2.12:1.0.0 # Please use 1.0.0 version for Spark3.2 and 1.0.0-spark3.3 version for Spark3.3
pyspark --packages com.microsoft.azure:synapseml_2.12:1.0.0
spark-submit --packages com.microsoft.azure:synapseml_2.12:1.0.0 MyApp.jar `}
                    lang="bash"
                  ></CodeSnippet>
                ...
                <TabItem value="Databricks">
                  ...
                  <p>
                    ...
                    Spark 3.3 Cluster:
                    <CodeSnippet
                      snippet={`com.microsoft.azure:synapseml_2.12:1.0.0-spark3.3`}
                      lang="bash"
                    ></CodeSnippet>
                    Spark 3.2 Cluster:
                    <CodeSnippet
                      snippet={`com.microsoft.azure:synapseml_2.12:1.0.0`}
                      lang="bash"
                    ></CodeSnippet>
                    with the resolver:
                    <CodeSnippet
                  ...
                  <CodeSnippet
                    snippet={`https://mmlspark.blob.core.windows.net/dbcs/SynapseMLExamplesv1.0.0.dbc`}
                    lang="bash"
                  ></CodeSnippet>
                </TabItem>
...
spark = (pyspark.sql.SparkSession.builder.appName("MyApp")
        .config("spark.jars.packages", "com.microsoft.azure:synapseml_2.12:1.0.0") # Please use 1.0.0 version for Spark3.2 and 1.0.0-spark3.3 version for Spark3.3
...
libraryDependencies += "com.microsoft.azure" %% "synapseml_2.12" % "1.0.0" // Please use 1.0.0 version for Spark3.2 and 1.0.0-spark3.3 version for Spark3.3`}
                    lang="jsx"
                  ></CodeSnippet>
                </TabItem>
                <TabItem value="dotnet">
                  ...
                  <CodeSnippet
                    snippet={`dotnet add package SynapseML.Cognitive --version 1.0.0
dotnet add package SynapseML.Core --version 1.0.0
dotnet add package SynapseML.Lightgbm --version 1.0.0
dotnet add package SynapseML.DeepLearning --version 1.0.0
dotnet add package SynapseML.Opencv --version 1.0.0
dotnet add package SynapseML.Vw --version 1.0.0`}
                    lang="bash"
                  ></CodeSnippet>
