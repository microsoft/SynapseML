...
spark-submit --packages com.microsoft.azure:synapseml_2.12:1.0.1 MyApp.jar `}
                ...
                <TabItem value="Databricks">
                  ...
                  <CodeSnippet
                    snippet={`https://mmlspark.blob.core.windows.net/dbcs/SynapseMLExamplesv1.0.1.dbc`}
                    lang="bash"
                  ></CodeSnippet>
                </TabItem>
...
libraryDependencies += "com.microsoft.azure" %% "synapseml_2.12" % "1.0.1" // Please use 1.0.1 version for Spark3.2 and 1.0.1-spark3.3 version for Spark3.3`}
                    lang="jsx"
                  ></CodeSnippet>
                </TabItem>
                <TabItem value="dotnet">
                  ...
                  <CodeSnippet
                    snippet={`dotnet add package SynapseML.Cognitive --version 1.0.1
dotnet add package SynapseML.Core --version 1.0.1
dotnet add package SynapseML.Lightgbm --version 1.0.1
dotnet add package SynapseML.DeepLearning --version 1.0.1
dotnet add package SynapseML.Opencv --version 1.0.1
dotnet add package SynapseML.Vw --version 1.0.1`}
                    lang="bash"
                  ></CodeSnippet>
