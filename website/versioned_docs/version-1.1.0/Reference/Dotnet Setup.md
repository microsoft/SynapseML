...
```
:::note
This tutorial uses Microsoft.Spark version 2.1.1 as SynapseML 1.1.0 depends on it.
...
dotnet add package SynapseML.Cognitive --version 1.1.0
```
...
Create a [TextSentiment](https://mmlspark.blob.core.windows.net/docs/1.1.0/dotnet/classSynapse_1_1ML_1_1Cognitive_1_1TextSentiment.html)
...
Refer to the [developer docs](https://mmlspark.blob.core.windows.net/docs/1.1.0/dotnet/index.html) for API guidance.
