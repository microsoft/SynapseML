...
spark = pyspark.sql.SparkSession.builder.appName("MyApp") \
            # Use 0.11.4-spark3.3 version for Spark3.3 and 1.0.14 version for Spark3.4
...
For the coordinates use: `com.microsoft.azure:synapseml_2.12:1.0.14` for Spark3.4 Cluster and
