...
spark = pyspark.sql.SparkSession.builder.appName("MyApp") \
            # Use 0.11.3-spark3.3 version for Spark3.3 and 0.11.3 version for Spark3.2
...
// Use 0.11.3 version for Spark3.2 and 0.11.3-spark3.3 for Spark3.3
...
```bash
# Please use 0.11.3-spark3.3 version for Spark3.3 and 0.11.3 version for Spark3.2
...
For the coordinates use: `com.microsoft.azure:synapseml_2.12:0.11.3` for Spark3.2 Cluster and
 `com.microsoft.azure:synapseml_2.12:0.11.3-spark3.3` for Spark3.3 Cluster;
...
%%configure -f
{
    "name": "synapseml",
    "conf": {
        # Please use 0.11.3 version for Spark3.2 and 0.11.3-spark3.3 version for Spark3.3
