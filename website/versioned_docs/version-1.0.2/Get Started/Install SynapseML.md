...
For the coordinates use: `com.microsoft.azure:synapseml_2.12:1.0.2` for Spark3.4 Cluster and
...
`https://mmlspark.blob.core.windows.net/dbcs/SynapseMLExamplesv1.0.2.dbc`
