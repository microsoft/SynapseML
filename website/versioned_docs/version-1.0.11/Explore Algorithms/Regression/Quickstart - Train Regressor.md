...
- [`TrainRegressor`
  ](https://mmlspark.blob.core.windows.net/docs/1.0.11/pyspark/synapse.ml.train.html?#module-synapse.ml.train.TrainRegressor)
- [`SummarizeData`
  ](https://mmlspark.blob.core.windows.net/docs/1.0.11/pyspark/synapse.ml.stages.html?#module-synapse.ml.stages.SummarizeData)
- [`CleanMissingData`
  ](https://mmlspark.blob.core.windows.net/docs/1.0.11/pyspark/synapse.ml.featurize.html?#module-synapse.ml.featurize.CleanMissingData)
- [`ComputeModelStatistics`
  ](https://mmlspark.blob.core.windows.net/docs/1.0.11/pyspark/synapse.ml.train.html?#module-synapse.ml.train.ComputeModelStatistics)
- [`FindBestModel`
  ](https://mmlspark.blob.core.windows.net/docs/1.0.11/pyspark/synapse.ml.automl.html?#module-synapse.ml.automl.FindBestModel)
