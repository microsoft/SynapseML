...
(SynapseML v1.0.4 only supports spark version >= 3.2.0)
...
```
:::note
This tutorial uses Microsoft.Spark version 2.1.1 as SynapseML 1.0.4 depends on it.
...
dotnet add package SynapseML.Cognitive --version 1.0.4
```
...
Create a [TextSentiment](https://mmlspark.blob.core.windows.net/docs/1.0.4/dotnet/classSynapse_1_1ML_1_1Cognitive_1_1TextSentiment.html)
...
```powershell
spark-submit --class org.apache.spark.deploy.dotnet.DotnetRunner --packages com.microsoft.azure:synapseml_2.12:1.0.4 --master local microsoft-spark-3-2_2.12-2.1.1.jar dotnet SynapseMLApp.dll
```
`--packages com.microsoft.azure:synapseml_2.12:1.0.4` specifies the dependency on synapseml_2.12 version 1.0.4;
...
Refer to the [developer docs](https://mmlspark.blob.core.windows.net/docs/1.0.4/dotnet/index.html) for API guidance.
